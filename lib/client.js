window.__ModuleLoader__.load({
  ...
  factory: function (require) {
    ...
    var css = "html:root{--dsw-font-family:'Anthropic Sans Web Text','Anthropic Sans SC',-apple-system,BlinkMacSystemFont,'Segoe UI','PingFang SC','Hiragino Sans GB','Microsoft YaHei','Helvetica Neue',Helvetica,Arial,sans-serif;--dsw-font-serif:'Anthropic Serif Web Text','Anthropic Serif SC',Georgia,'Times New Roman','Songti SC','SimSun',serif}" +
      "html body{" +
